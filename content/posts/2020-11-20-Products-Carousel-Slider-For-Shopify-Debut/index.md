...
excerpt: I´m going to show you step by step how to implement Product slider within the Debut theme.
---
...
3. Find the theme that called *Copy of Debut* then click **Actions** > **Edit Code**.
4. On the left bar, search for a folder called *Assets* then Copy and paste the following code inside the file 'vendor.js' at the bottom then Save.
```js
/*!
Slick.js
Version: 1.8.0
...
```
**5.** On the same folder which is *Assets*. Create a file called 'slick.css.liquid'
...
```
**7.** Again on the same folder *Assets*. Create another file called 'slick-theme.css.liquid'
...
```
**9.** Next, On the left bar, search for a folder called *Layout* then find a file called 'theme.liquid'.

**11.** Copy and paste the following code inside the 'theme.liquid' file on the line 41 in your code editor
```
{{ 'slick.css' | asset_url | stylesheet_tag }}
{{ 'slick-theme.css' | asset_url | stylesheet_tag }}
```
**12.** Next, On the left bar, search for a folder called *Sections* then create a new file called 'products-slider.liquid'.
