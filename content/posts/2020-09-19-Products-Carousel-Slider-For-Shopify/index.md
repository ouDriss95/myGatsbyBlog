...
excerpt: I´m going to show you step by step how to implement Product slider within the Minimal theme.
---
...
4. On the left bar, search for a folder called *Assets* then create a new file called 'slick.min.js'.
...
```
**6.** On the same folder which is *Assets*. Create another file called 'slick.css.liquid'
...
```
**8.** Again on the same folder *Assets*. Create another file called 'slick-theme.css.liquid'
...
```
**10.** Next, On the left bar, search for a folder called *Layout* then find a file called 'theme.liquid'.
...
```
**13.** Next, On the left bar, search for a folder called *Sections* then create a new file called 'products-slider.liquid'.
